...
> 1. Abra o mapa da disciplina.
> 2. Leia a aula e siga os links de conexão.
> 3. Marque `revisao: true` após conferir o conteúdo.
> 4. Use o [[99 - Templates/Template - Revisão|template de revisão]] antes da prova.

Para aprender a manter a estrutura, consulte o [[01 - Painel/Guia do Cofre|Guia do Cofre]].
