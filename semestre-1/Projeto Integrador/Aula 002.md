...
### PI1
O Projeto gira em torno de um problema apresentado para a sala por um terceiro:
A partir do problema, deveremos apresentar uma solução após estudá-lo:
- Levantar os requisitos do sistema para a resolução (Foco Principal)
- Modelar / Construir Pseudocódgos e Fluxogramas (Durante o PI1)
...
- Os Professores das Disciplinas-Satélites
	Vão dar apoio no conteúdo prático usado no desenvolvimento do projeto.
- Professor(a) da Disciplina-Chave
